...
class WaypointUpdater(object):
    ...
    def get_closest_waypoint_idx(self):
        ...
        previous_coord = self.waypoints_2d[closest_waypoint_idx - 1]
    ...
    def decelerate_waypoints(self, base_waypoints, closest_waypoint_idx):
        temp = []
        for i , waypoint in enumerate(base_waypoints):
            p = Waypoint()
            p.pose = waypoint.pose
            stop_idx = max(self.stopline_wp_idx - closest_waypoint_idx - 4, 0)
